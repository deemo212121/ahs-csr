...
function roleHeadline(role: string | null) {
  ...
  if (role === 'admin') return { title: 'All Calls', subtitle: 'Company-wide call queue across every branch, CSR, and team leader.' };
  ...
  return (
    <div className="call-manual-backdrop" role="presentation" onClick={onClose}>
      <section className="call-manual-panel" role="dialog" aria-modal="true" onClick={(event) => event.stopPropagation()}>
        ...
        <form className="manager-manual-form-panel call-manual-form-panel" onSubmit={submit}>
          <section className="request-section">
            ...
            <div className="form-grid manual-grid">
              ...
              <div className="field"><label>Primary Phone *</label><input required value={form.phone_number} onChange={(event) => update('phone_number', event.target.value)} placeholder="Optional for WebRTC" /></div>
              ...
              <div className="field wide"><label>Address *</label><input required value={form.service_address} onChange={(event) => update('service_address', event.target.value)} placeholder="Customer service address" /></div>
          ...
          <button className="btn btn-primary manual-submit" disabled={saving} type="submit">
